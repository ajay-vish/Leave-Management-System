     <aside id="slide-out" class="side-nav white fixed">
                <div class="side-nav-wrapper">
                    ...
                    <?php 
$eid=$_SESSION['eid'];
$sql = "SELECT FirstName,EmpId from  tblemployees where id=:eid";
...
{               ?>  
                                <p><?php echo htmlentities($result->FirstName);?> </p>
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="emp-changepassword.php"><i class="material-icons">settings_input_svideo</i>Chnage Password</a></li>
          ...
          <li class="no-padding"><a class="waves-effect waves-grey" href="slots.php"><i class="material-icons">account_box</i>Slot Request</a></li>
